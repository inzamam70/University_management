                    ...
                    <tr>
                        ...
                        <td style="margin-left :20px;">
                            <div class="action-btn">
                             <a href="view-gallery.php?id=<?= $row['id'] ?>" style="background:green;">View</a>
                             <a href="edit-gallery.php?id=<?= $row['id'] ?>" style="background:blue;">Edit</a>
                             <a href="delete-gallery.php?id=<?= $row['id'] ?>" style="background:red;">Delete</a>  
                            </div>
