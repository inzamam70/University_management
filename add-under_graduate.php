...
if(isset($_POST['submit'])){
    ...
    $vision = $_POST['vision'];
    $mision = $_POST['mision'];
    $sql = "INSERT INTO `under_graduate`(`university_id`, `academic_id`, `name`, `description`, `vision`, `mision`) VALUES ('$university_id','$academic_id','$name','$description','$vision','$mision')";
                ...
                <div class="form">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="vision" placeholder="Enter Vision">
                        </div>

                        <div class="input-group">
                            <label for="mision">Mission</label>
                            <input type="text" name="mision" placeholder="Enter Mission">
                        </div>
