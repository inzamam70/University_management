...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `catalog`(`university_id`, `academic_id`, `image`) VALUES ('$university_id','$academic_id','$path')";
    $result = mysqli_query($conn, $sql);
    if($result){
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Success!</strong> Catalogs Added Successfully.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>';
      header("Location: catalogs.php");
    }else{
        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Error!</strong> catalog Not Added.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>';
    }
}
            ...
            <div class="table">
                ...
                <div class="form">
                    ...
                    <div class="input-group" >
                        ...
                        <div class="input-group">
                            <button type="submit" name="submit">Add Catalog</button>
                        </div>
