...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `faculty_member`(`university_id`, `academic_id`, `name`, `designation`, `image`) VALUES ('$university_id','$academic_id','$name','$designation','$path')";
    $result = mysqli_query($conn, $sql);

    if($result){
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Success!</strong>Faculty member Added Successfully.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>';
        header("Location: faculty-members.php");
    }else{
        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Error!</strong>Faculty member Not Added.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>';
    }      
}
            ...
            <div class="table">
                ...
                <div class="form">
                    ...
                    <div class="input-group" >
                        ...
                        <div class="input-group">
                            <label for="name">faculty Member Name</label>
                        ...
                        <div class="input-group">
                            <button type="submit" name="submit">Add Faculty Member</button>
                        </div>
