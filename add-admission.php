...
if(isset($_POST['submit'])){
    ...
    $name = $_POST['name'];
    $web = $_POST['web'];
    $sql = "INSERT INTO admission (university_id, name,web) VALUES ('$university_id', '$name','$web')";

    $result = mysqli_query($conn, $sql);

    if($result){
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Success!</strong> Admission Added Successfully.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>';
        header("Location: admissions.php");
    }else{
        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Error!</strong> Admission Not Added.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>';
    }      
}
            ...
            <div class="table">
                ...
                <div class="form">
                    ...
                    <label for="university_id">University</label>
                        ...
                        <div class="input-group">
                            <button type="submit" name="submit">Add Admission</button>
                        </div>
