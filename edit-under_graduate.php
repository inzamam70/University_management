...
if(isset($_POST['submit'])){
    ...
    $vision = $_POST['vision'];
    $mision = $_POST['mision'];
    $sql = "UPDATE under_graduate SET name = '$name', description = '$description', vision = '$vision', mision = '$mision' WHERE id = '$id'";
                ...
                <div class="form">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="input-group">
                            ...
                            <?php 
                            $sql = "SELECT * FROM under_graduate WHERE id = '$id'";
                            $result = mysqli_query($conn, $sql);
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="vision"  value="
                            <?php 
                            $sql = "SELECT * FROM under_graduate WHERE id = '$id'";
                            $result = mysqli_query($conn, $sql);
                            if (mysqli_num_rows($result) > 0) {
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="mision"  value="
                            <?php 
                            $sql = "SELECT * FROM under_graduate WHERE id = '$id'";
                            $result = mysqli_query($conn, $sql);
                            if (mysqli_num_rows($result) > 0) {
