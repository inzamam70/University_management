...
<body>
    ...
    <div class="academic-item-body">
        ...
        <div class="academic-main-txt">
            <h1><span>Semester-wise Course Distribution for B. Sc. in CSE</span></h1>
        </div>
        ...
        <div class="academic-item">
            ...
            <!-- <div class="academic-details"> -->
                 ...
                 <?php
                    ...
                    $sql = "SELECT * FROM `catalog` WHERE academic_id = '$academic_id' AND university_id = '$university_id'";
