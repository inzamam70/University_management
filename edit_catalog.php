...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE catalog SET  image = '$path' WHERE id = '$id'";
    $result = mysqli_query($conn, $sql);
    if ($result) {
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Success!</strong> Catalog Updated Successfully.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>';
      header("Location: catalogs.php");
    } else {
        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Error!</strong> catalog Not Updated.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>';
    }
}
            ...
            <div class="table">
                ...
                <div class="form">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <button type="submit" name="submit">Update catalog</button>
                        </div>
